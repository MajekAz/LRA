...
const Services: React.FC = () => {
  ...
  const faqs = [
    ...
    { q: "Do you provide on-site support for international setups?", a: "Yes, we have a physical presence in Gothenburg and a strategic hub in London, allowing us to provide both remote strategy and on-the-ground operational support." },
